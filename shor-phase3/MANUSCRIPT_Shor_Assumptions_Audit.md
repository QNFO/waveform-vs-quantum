...
**Directly relevant QNFO publications:**
- **Feynman-Shor Quantum Bifurcation** (`paper-feynman-shor-quantum-bifurcation`) — QNFO paper on Shor/Feynman quantum-classical bifurcation
- **GEOMETRIC QUANTUM ADVANTAGE** (`paper-geometric-quantum-advantage`) — QNFO paper on geometric formulations of quantum advantage
